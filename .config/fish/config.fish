...
set -U FZF_FIND_FILE_COMMAND 'rg --files --follow --no-ignore-vcs --hidden -g "!{node_modules/*,.git/*}"'
set -U FZF_CD_COMMAND 'rg --files --follow --no-ignore-vcs --hidden -g "!{node_modules/*,.git/*}"'
set -U FZF_CD_WITH_HIDDEN_COMMAND 'rg --files --follow --no-ignore-vcs --hidden -g "!{node_modules/*,.git/*}"'
set -U FZF_TMUX 1
set -U FZF_DEFAULT_OPTS '--height 20%'
