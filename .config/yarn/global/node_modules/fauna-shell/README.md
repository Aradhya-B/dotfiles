...
* [`fauna run-queries [QUERY]`](#fauna-run-queries-query)
...
_See code: [src/commands/add-endpoint.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/add-endpoint.js)_
...
_See code: [src/commands/cloud-login.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/cloud-login.js)_
...
_See code: [src/commands/create-database.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/create-database.js)_
...
_See code: [src/commands/create-key.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/create-key.js)_
...
_See code: [src/commands/default-endpoint.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/default-endpoint.js)_
...
_See code: [src/commands/delete-database.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/delete-database.js)_
...
_See code: [src/commands/delete-endpoint.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/delete-endpoint.js)_
...
_See code: [src/commands/delete-key.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/delete-key.js)_
...
_See code: [src/commands/eval.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/eval.js)_
...
_See code: [src/commands/list-databases.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/list-databases.js)_
...
_See code: [src/commands/list-endpoints.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/list-endpoints.js)_
...
_See code: [src/commands/list-keys.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/list-keys.js)_

## `fauna run-queries [QUERY]`
...
_See code: [src/commands/run-queries.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/run-queries.js)_
...
_See code: [src/commands/shell.js](https://github.com/fauna/fauna-shell/blob/v0.11.5/src/commands/shell.js)_
<!-- commandsstop -->
